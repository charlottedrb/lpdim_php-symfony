    ...
    <div class="flex flex-col mb-2">
        <div class="relative">
            <input type="string"
                   ...
                   id="name" aria-describedby="name" placeholder="Name" name="name" value="<?php if(!is_array($game)): echo $game->getName(); else: echo "Name"; endif; ?>">
        </div>
    </div>
    <div class="flex flex-col mb-2">
        <div class=" relative ">
            <input type="string"
                   ...
                   name="image" value="<?php if(!is_array($game)): echo $game->getImage(); else: echo "Image URL"; endif; ?>">
        </div>
    </div>
